...
/* package meuprojeto-0.1.0.0 */
#ifndef VERSION_meuprojeto
#define VERSION_meuprojeto "0.1.0.0"
#endif /* VERSION_meuprojeto */
#ifndef MIN_VERSION_meuprojeto
#define MIN_VERSION_meuprojeto(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_meuprojeto */
...
#define CURRENT_COMPONENT_ID "meuprojeto-0.1.0.0-LAhE9QEM6YV1gGc0BQe7lC-meuprojeto"
