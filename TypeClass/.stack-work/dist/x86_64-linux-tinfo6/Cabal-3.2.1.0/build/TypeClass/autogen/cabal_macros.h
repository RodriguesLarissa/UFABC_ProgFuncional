...
/* package TypeClass-0.1.0.0 */
#ifndef VERSION_TypeClass
#define VERSION_TypeClass "0.1.0.0"
#endif /* VERSION_TypeClass */
#ifndef MIN_VERSION_TypeClass
#define MIN_VERSION_TypeClass(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_TypeClass */
...
#define CURRENT_COMPONENT_ID "TypeClass-0.1.0.0-9X9FPomPnYa77oOAfsYsfE-TypeClass"
