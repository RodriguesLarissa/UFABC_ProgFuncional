...
/* package DataType-0.1.0.0 */
#ifndef VERSION_DataType
#define VERSION_DataType "0.1.0.0"
#endif /* VERSION_DataType */
#ifndef MIN_VERSION_DataType
#define MIN_VERSION_DataType(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_DataType */
...
#define CURRENT_COMPONENT_ID "DataType-0.1.0.0-9U6Cc6iiIXY8S4fEeDhlkI-DataType"
