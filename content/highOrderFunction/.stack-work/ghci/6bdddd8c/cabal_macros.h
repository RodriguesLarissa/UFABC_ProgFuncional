...
/* package highOrderFunction-0.1.0.0 */
#ifndef VERSION_highOrderFunction
#define VERSION_highOrderFunction "0.1.0.0"
#endif /* VERSION_highOrderFunction */
#ifndef MIN_VERSION_highOrderFunction
#define MIN_VERSION_highOrderFunction(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_highOrderFunction */
...
#define CURRENT_COMPONENT_ID "highOrderFunction-0.1.0.0-9FQSqDLRgR3LRqi3ht4X0R-highOrderFunction"
